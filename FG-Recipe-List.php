<?php 
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-default">
            ...
            <th>Action</th>
                ...
                <tbody>'; 
    $sl =1;
    $qry = $conn_me->prepare("SELECT * FROM `receip_fg` GROUP BY `product_id`  ORDER BY `id` ASC");
    $qry->execute();
    ...
    if ($qry->rowCount() > 0)
    {
        foreach($fetch_list AS $fetch) {
            ...
            <td><a href="Recipe/FG-Recipe-Setup/New/'.$fetch['product_id'].'"><i class="fa fa-edit danger"></i><a></td>
           </tr>';
        }
