...
<table class="table table-hover table-condensed table-striped table-bordered" style="margin-bottom: 0px;">
                <tbody> 
                    ...
                    <tr>
                        <th>From</th>
                        <td><input  type="texxt" value="<?php print date('d-m-Y');?>" id="date_from" class="date form-control" ></td>
                        <th>To</th>
                    ...
                    <tr>
                        ...
                        <td colspan="3" style="text-align:center">
                            <input type="button" onclick="modifyreport('Product-Sale-Summery');" class="btn btn-info block" value="SEARCH DATA" id="search_data" name="search_data" ></td>
                    </tr>
</tbody>
</table>
...
<div class="btn-group pull-right">
    ...
    <ul class="dropdown-menu">
        <li><a  onclick="printButtn(' :: Product-Sale-Summery','MSalary')" ><img src="img/icons/json.png" width="24"/>Print</a></li>
        <li><a onclick="exportToExcel('Product-Sale-Summery','MSalary')"; ><img src="img/icons/xls.png" width="24"/> XLS</a></li>
    </ul>
</div>                                    
