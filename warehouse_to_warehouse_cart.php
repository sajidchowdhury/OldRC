...
<?php 
    ...
    $query = $conn_me->prepare("SELECT *  FROM `fg_warehouse_to_warehouse_transfer`  where `poster` = '".$_SESSION['NEWERP_SESS_MEMBER_ID']."' AND `status` = 'Pending' ");
                    ...
                    foreach ($fetch_list as $fetch) { 
                        ...
                        $CART_DATA = SETUP::FG_warehouse_to_warehouse_transfer($fetch['id']);
