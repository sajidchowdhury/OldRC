$(function () {
  var formElements = (function () {
    ...
    var feColorpicker = function () {
      ...
      // Sample
      if ($("#colorpicker").length > 0) $("#colorpicker").colorpicker();
    ...
    return {
      // Init all form element features
      init: function () {
        feDatepicker();
        feTimepicker();
        feColorpicker();
        ...
        $("#new-event").on("click", function () {
          ...
          if (et != "") {
            $("#external-events").prepend(
              '<a class="list-group-item external-event">' + et + "</a>"
            );
            prepare_external_list();
          }
        });
    ...
    if (action == "show" || action == "update") {
      if (action == "show") {
        ...
        var mpb =
          ...
          (settings.state != "" ? " mpb-" + settings.state : "") +
          '" style="width:' +
          settings.value[0] +
          '%;"></div>\n\
                           </div>';
      ...
      var i = $.isArray(settings.value)
        ? settings.value[0]
        : $(".mpb .mpb-progress").width();
