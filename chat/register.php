...
if(isset($_POST["register"]))
{
    ...
    else
    {
        if($user_object->save_data())
        {
            ...
            $mail->setFrom('sajid@webslesson.info', 'Webslesson');
            ...
            <p>Thank you for registering for Chat Application Demo.</p>
                ...
                <p><a href="http://localhost/rc_center/chat/verify.php?code='.$user_object->getUserVerificationCode().'">Click to Verify</a></p>
                <p>Thank you...</p>
            ';
