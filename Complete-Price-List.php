...
<div class="col-md-4 col-xs-12"><input type="button" onclick="generateReport('Complete Price List','category_id');" class="btn btn-info block" value="SEARCH DATA" id="search_data" name="search_data" >
</div></div>
