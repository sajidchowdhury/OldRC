...
<div class="col-md-4 col-xs-12"><input type="button" onclick="find_sales_invoice_by_no('Damage Return');" class="btn btn-info block" value="SEARCH INVOICE" id="search_invoice" name="search_invoice" >
</div></div>
