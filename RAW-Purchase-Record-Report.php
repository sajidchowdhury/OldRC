...
<option  value="Raw-Material">Product Wise</option>
<option  value="Raw-Category">Category Wise</option>
...
<option  value="Employee-Wise">By Employee</option>
    ...
    <span></span>
                        ...
                        <td colspan="3" style="text-align:center">
                            <input type="button" onclick="purchase_record_report('target1','RAW');" class="btn btn-info block" value="SEARCH DATA" id="search_data" name="search_data" ></td>
                    </tr>
</tbody>
</table>
