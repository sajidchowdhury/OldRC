...
<option  value="Multipal-Sales-Person">Employee Wise</option>
...
<div class="col-sm-4"></div>
<div class="col-sm-4">
<input type="button" onclick="CommonReportGenerator('Salesman Performance Report');" class="btn btn-info block" value="SEARCH DATA" id="search_data" name="search_data" ></td>
</div>
<div class="col-sm-4"></div>
