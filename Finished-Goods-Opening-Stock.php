...
$DATA  = SETUP::FG_OPENINGSTOCK($_GET['related_id']);
$related_id = $DATA['id'];
...
<ul class="breadcrumb">
    ...
    <li class="active">Finished-Goods-Opening-Stock</li>
</ul>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Add Opening Stock </strong> <b id="mess_box"></b>  </h3>
...
<?php 
 ...
 <?php } ?>
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text"  class="date form-control" value="<?php print $writeoff_date;?>" id="writeoff_date" name="writeoff_date" >        
                                                    </div>
                                                    <span class="help-block"></span>
                                                </div>
                                            </div>
                                ...
                                <div class="panel-footer">
                                              ...
                                              <input type="button" class="btn btn-danger pull-right" value="Final Data" onclick="" id="final_writeoff" name="final_writeoff" >
                                              
                                              
                                    <?php if($_GET['related_id'] == 'New'){ ?>
                                        <input type="button" id="add_cart_writeoff" name="add_cart_writeoff" class="btn btn-info pull-left" value="Add++"  >
                                        <?php  }else{?>
                                            <input style="margin-left:15px;" type="button" class="btn btn-warning pull-left" value="Update" id="add_cart_writeoff" name="add_cart_writeoff" >
                                            <a class="btn btn-info pull-left" href="Inventory/Finished-Goods-Opening-Stock/New" >Add New</a>
                                            <?php  }?>
...
<?php include('opening-stock-cart.php');?>
</div>