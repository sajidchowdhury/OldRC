...
$invoice_info = SETUP::SETUP_QUATATION_INVOICE($_GET['id']);
...
<tr >
<td colspan="2" style="line-height:10px;text-align:left;padding: 10px 10px;border : 1px solid; ">ইনভয়েস নং <?php print  $invoice_info['invoice_no'];?></td>
