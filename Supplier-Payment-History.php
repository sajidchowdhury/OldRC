...
<option value="">Select One</option>
                                        <option value="Multipal-Supplier-Wise">Supplier Wise</option>
...
<div class="col-sm-4"></div>
<div class="col-sm-4">
<input type="button" onclick="CommonReportGenerator('Supplier Payment History');" class="btn btn-info block" value="SEARCH DATA" id="search_data" name="search_data" ></td>
</div>
<div class="col-sm-4"></div>
