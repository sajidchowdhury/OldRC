...
<select class="form-control select" id="employee_id" name = "employee_id"  data-live-search="true">
...
<tr>
                        ...
                        <td  colspan="3"><input  type="button" id="search_data" value="Search Data" onclick="generateReport('Monthly-Leave-Report','employee_id')" class="btn btn-info block" ></td>
</tr>
